...
\subsection{Incidence by Gender and Education}
...
\begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.48\textheight,keepaspectratio]{Incidence_gender_Education/Belgium.png}\\[0.5em]
    \includegraphics[width=1.0\textwidth,height=0.48\textheight,keepaspectratio]{Incidence_gender_Education/France.png}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.48\textheight,keepaspectratio]{Incidence_gender_Education/Canada.png}\\[0.5em]
    \includegraphics[width=1.0\textwidth,height=0.48\textheight,keepaspectratio]{Incidence_gender_Education/Germany.png}
\end{minipage}
\caption{Incidence by Gender and Education: Belgium, Canada, France, Germany}
\end{figure}
\end{landscape}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Japan.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Korea.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Mexico.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/New Zealand.png}
\caption{Incidence by Gender and Education: Japan, Korea, Mexico, New Zealand}
\end{figure}
\end{landscape}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Poland.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Portugal.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Spain.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Sweden.png}
\caption{Incidence by Gender and Education: Poland, Portugal, Spain, Sweden}
\end{figure}
\end{landscape}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/Switzerland.png}
\includegraphics[width=0.45\textwidth]{Incidence_gender_Education/UK.png}
\caption{Incidence by Gender and Education: Switzerland, UK}
\end{figure}
\end{landscape}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Belgium.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Canada.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/France.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Germany.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Japan.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Korea.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Mexico.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/New Zealand.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Poland.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Portugal.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Spain.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Sweden.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/Switzerland.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Education/UK.png}
\caption{Incidence by Gender and Education}
\end{figure}
\end{landscape}

\subsection{Incidence by Gender and Industry}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Belgium.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Canada.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/France.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Germany.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Japan.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Korea.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Mexico.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/New Zealand.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Poland.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Portugal.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Spain.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Sweden.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/Switzerland.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_Industry/UK.png}
\caption{Incidence by Gender and Industry}
\end{figure}
\begin{landscape}
\begin{figure}[H]
\centering
...
\subsection{Incidence by Gender and Position}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Belgium.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Canada.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/France.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Germany.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Japan.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Korea.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Mexico.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/New Zealand.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Poland.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Portugal.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Spain.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Sweden.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/Switzerland.png}
\includegraphics[width=0.9\textwidth]{Incidence_gender_position/UK.png}
\caption{Incidence by Gender and Position}
\end{figure}
\begin{landscape}
\begin{figure}[H]
\centering
...
% --- Compensation Images ---
\subsection{Compensation by Type and Gender}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Belgium.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Canada.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/France.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Germany.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Japan.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Korea.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Mexico.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/New Zealand.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Poland.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Portugal.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Spain.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Sweden.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/Switzerland.png}
\includegraphics[width=0.9\textwidth]{compensation_type_gender/UK.png}
\caption{Compensation by Type and Gender}
\end{figure}
\begin{landscape}
\begin{figure}[H]
\centering
